...
int train(char *filename){
  ...
  float eta,suma;
  float mse,mse_train,mse_valid,mse_test,minimo_valid, minimo_mse_train;
  ...
  printf("\nError minimo en validacion:\nEpoca:%d\nValidacion:%f\n>> Test: %f Train: %f\nTest discreto:%f%%\n\n",epocas_del_minimo,minimo_valid,mse_test, minimo_mse_train,100.0*disc_test);
